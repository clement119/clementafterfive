...
const journal = [
        ...
        tips: [
            ...
            items: [
              ...
              { text: "Each demo ships with a copy-paste build prompt rather than a code dump \u2014 the same loop as the rest of this note: examples in, sharper prompt out. Best experienced by actually hovering things:", plain: true },
              {
                link: {
                  ...
                  label: "The Hover Interaction Collection \u2014 Janus Tiu",
                  compact: true,
                },
              },
            ],
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Never fire the real action on hover \u2014 preview only. Hover is not consent.", copy: true },
          ...
          {
            title: "Build your own \u2014 copy this prompt",
            items: [
              {
  ...
  {
    dimension: "Ideas and Inspo",
    title: "Point, Capture, Ask",
    subtitle:
      "Clicky put an AI on the Mac that sees whatever you're looking at. The workplace version of that idea: point at the thing on screen, capture it, and ask about it in place \u2014 no paste, no re-explaining.",
    date: "2026-09-01",
    sections: [
      {
    ...
    footer:
      "The models are good enough already \u2014 what's still expensive is explaining to them where you are. Pointing is cheaper than describing.",
  },
];
